...
export class SignalTwo<T, U> extends Signal {
	...
	public add( listener:( param1:T, param2:U, ...rest:any[] ) => any, listenerContext?:any, priority?:number, ...args:any[] ):SignalBinding {
		return super.add( listener, listenerContext, priority, ...args );
	}

	public addOnce( listener:( param1:T, param2:U, ...rest:any[] ) => any, listenerContext?:any, priority?:number, ...args:any[] ):SignalBinding {
	...
	public remove( listener:( param1:T, param2:U, ...rest:any[] ) => any, context?:any ):( param1:T, param2:U, ...rest:any[] ) => any {
