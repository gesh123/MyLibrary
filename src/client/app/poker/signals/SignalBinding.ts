...
export class SignalBinding {
	...
	/**
	 * Listener arguments. Additional arguments to pass to the callback (listener) function. They will be appended after any arguments usually dispatched.
	 * @type Array|null
	 */
	private _args:any[];
	 ...
	 */
	constructor( signal:Signal, listener:any, isOnce:boolean, listenerContext:any, priority:number = 0, args?:any[] ) {
