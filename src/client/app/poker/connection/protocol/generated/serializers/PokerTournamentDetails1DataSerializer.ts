...
export class PokerTournamentDetails1DataSerializer {
	public static serialize(buffer: ArrayBufferBuilder, data: PokerTournamentDetails1Data): void {
	...
	public static deserialize(buffer: ArrayBufferBuilder, data: PokerTournamentDetails1Data): void {
		var bitsReader = new BitsReader( buffer );
